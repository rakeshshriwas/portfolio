...
export default function HeroSection() {
  return (
    <main className="flex flex-col items-center pt-32 max-md:px-4">
      ...
      <div className="mt-6 flex flex-row flex-wrap justify-center gap-2 sm:justify-start">
        ...
        <a
          ...
          target="_blank"
          className="group bg-indigo-600 hover:bg-indigo-700 text-white px-7 py-2.5 rounded-full"
        >
          Download CV
          <Download className="group-hover:translate-x-0.5 transition ml-1 size-4 inline-flex" />
        </a>
      </div>
      <div className="mt-10 flex flex-row flex-wrap justify-center gap-2 sm:justify-start">
        <a
        ...
        >
          <svg
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            className="lucide lucide-codepen-icon lucide-codepen"
          >
